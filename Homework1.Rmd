...
### ANSWER: The reason why we get two different pictures by running the code is that the second sampling is a process after the first sampling, instead of a process beginning at the seed 50.
